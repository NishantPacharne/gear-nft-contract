import { System, SafeMath, Protobuf, Arrays, authority, Token, error, StringBytes, Base58, Storage } from "@koinos/sdk-as";
import { collections } from "./proto/collections";
import { IToken, token } from "@koinosbox/contracts";

import { game } from "./proto/game";

import { gameContract } from "./Igame";
...
export class Collections {
  ...
  mint(args: collections.mint_arguments): collections.empty_object {
    ...
    System.require(Arrays.equal(System.getCaller().caller, Base58.decode("1ESdsqX9vKyqGMvyawUEUGpvLMEeznpadK")), "Caller is not authorized");
